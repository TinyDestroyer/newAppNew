        ...
        <div className="flex flex-col justify-center itmes-center w-full">
          ...
          <div className="flex flex-col justify-end mx-auto mt-auto m-2 w-3/5 text-gray-700">
            {chats.map((chat,index) => (
              <div key={index} className={`flex mb-2 gap-3 ${chat.name !== "system" && "justify-end"}`}>
                ...
                <div className={`flex p-2 px-4 text-base text-black rounded-2xl ${chat.name !== "system" && "justify-end bg-emerald-500 rounded-br-none"} ${chat.name == "system" && "bg-stone-800 text-white rounded-tl-none mb-2 w-10/12"}`}>
                  <ReactMarkdown className="prose">{chat.chat}</ReactMarkdown>
                </div>
                {chat.name !== "system" && 
                  <Avatar>
          ...
          <div id="targetDiv" className="flex gap-2 justify-center items-center w-full">
            ...
            <div className="flex gap-2 justify-center items-center w-full">
              ...
              />
              <button disabled = {query == "" ? true : false} onClick={test}>
